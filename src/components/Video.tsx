  ...
  return (
    <div className="flex-1">
      <div className="bg-black justify-center">
        <div className="h-full w-full max-w-[1100px] max-h-[60vh] aspect-video jus"></div>
      </div>
            ...
            <p className="mt-4 text-gray-200 leading-relaxed">
              ...
              <div className="flex items-center gap-4 mt-6">
                <img
                  ...
                  src="https://github.com/thiagomoz.png"/>

                  <div className="leading-relaxed">
                    <strong className="font-bold text-2xl block">
                      Thiago Oliveira
                    </strong>
                    <span className="text-gray-200 text-sm block">CTO @Headify</span>
